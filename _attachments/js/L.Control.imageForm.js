L.Control.imageForm = L.Control.extend({
  ...
  initialize: function(placeholder, options) {
    ...
    var container = this._container =
      L.DomUtil.create('div', l + 'imageForm');
...
L.control.imageForm = function(placeholder, options) {
  return new L.Control.imageForm(placeholder, options);
};