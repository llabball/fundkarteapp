L.Control.lightBox = L.Control.extend({
  ...
  initialize: function(placeholder, options) {
    ...
    var container = this._container =
      L.DomUtil.create('div', l + 'lightBox');
...
L.control.lightBox = function(placeholder, options) {
  return new L.Control.lightBox(placeholder, options);
};